        ...
        <div class="row">
            <div class="col-md-4 mb-3">
                ...
                <select class="form-select" id="categoria" name="categoria" required>
                    ...
                    <option value="anillo" {{ old('categoria') == 'anillo' ? 'selected' : '' }}>Anillo</option>
                    <option value="pulsera" {{ old('categoria') == 'pulsera' ? 'selected' : '' }}>Pulsera</option>
                    <option value="pendiente" {{ old('categoria') == 'pendiente' ? 'selected' : '' }}>Pendiente</option>
                    <option value="collar" {{ old('categoria') == 'collar' ? 'selected' : '' }}>Collar</option>
                </select>
            </div>
            <div class="col-md-4 mb-3">
