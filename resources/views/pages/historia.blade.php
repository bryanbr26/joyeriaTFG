...
<section class="historia-hero" id="texto_historia">
    ...
    <div class="content container text-center py-5">
        ...
        <br><br>
        <h4>
            Fundada en el año 2012, Joyas Pérez nació del espíritu emprendedor de Wilson Pérez, <br>
            un orfebre apasionado que decidió establecer su taller en el corazón de Soria.<br> <br>

            Wilson, mucho antes de la apertura de su propia joyería, ya trabajaba como joyero, <br>
            sin embargo, tenía una visión muy clara de lo que quería crear. <br><br>
            ...
            Aunque sus diseños exclusivos ahora se envían a toda España gracias a su tienda online, el alma de Joyas Pérez <br>
            sigue intacta en su coqueta boutique del centro de Soria.<br><br>
