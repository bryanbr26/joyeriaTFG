...
<div class="container my-4">
    ...
    <form action="{{ route('joyas.update', [$categoria, $producto]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="mb-3">
            ...
            @if($producto->imagen_principal_url)
                <div class="mb-2">
                    <img src="{{ $producto->imagen_principal_url }}" alt="{{ $producto->nombre }}" width="100" height="100" style="object-fit: cover;" class="border rounded" loading="lazy">
