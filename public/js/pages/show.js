"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["/js/pages/show"],{
...
function initProductosShow() {
  var imagenCol = document.querySelector('.producto-detalle-imagen');
  var infoCol = document.querySelector('.producto-info');
  ...
  function crearScrollTrigger() {
    ...
    scrollTriggerInstance = gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.create({
      trigger: '.producto-detalle-grid',
      start: 'top top',
      end: function end() {
        return "+=".concat(imagenCol.offsetHeight - infoCol.offsetHeight);
      },
      pin: infoCol,
      pinSpacing: false,
      anticipatePin: 1,
  ...
  document.querySelectorAll('.dropdown-custom .dropdown-header').forEach(function (header) {
  ...
  // ==========================================
  var btnCestaAuth = document.getElementById('btnAnadirCestaAuth');
  if (btnCestaAuth) {
      ...
      fetch(url, {
        ...
        if (data.success) {
          ...
          if (data.cartHtml) {
            ...
            var newPanel = tempDiv.querySelector('.panel-carrito');
            if (newPanel) {
  ...
  document.querySelectorAll('.modal-overlay, [data-modal-close]').forEach(function (el) {
    el.addEventListener('click', function (e) {
      if (e.target === this || this.dataset.modalClose !== undefined) {
        var modal = this.closest('.modal-overlay') || document.querySelector('.modal-overlay.activo');
...
/******/ var __webpack_exports__ = (__webpack_exec__("./resources/js/pages/show.js"));
/******/ }
]);
